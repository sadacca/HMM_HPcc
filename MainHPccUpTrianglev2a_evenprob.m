function MainHPccUpTrianglev2a_evenprob(par)
...
pscaled=...
    [1.0000    1.9000    1.5000    1.1000    0.9000    0.5000    0.1000;...
    0    1.0000    1.9000    1.5000    1.0000    0.5000    0.1000;...
    0         0    1.0000    1.9000    1.5000    0.5000    0.1000;...
    0         0         0    1.0000    1.9000    1.0000    0.1000;...
    0         0         0         0    1.0000    1.9000    0.1000;...
...
for n = 1:n_HM_models
    ...
    pALL(end,end)=1;
    p = pALL.*pscaled(end-n+1:end,end-n+1:end);
